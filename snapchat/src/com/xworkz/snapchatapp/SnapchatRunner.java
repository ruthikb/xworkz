...
public class SnapchatRunner {
    ...
    public static void main(String[] args) {
        ...
        snapchatDto.setFirstName("Karthik");
        snapchatDto.setLastName("A R");
        snapchatDto.setDob("15/08/1998");
        snapchatDto.setGender(Gender.male);
        snapchatDto.setEmail("Karthik A R@snapchat.com");
        snapchatDto.setMobile("9876543210");
        snapchatDto.setUserName("karthik_snap");
        snapchatDto.setPassword("snap@karthik");
